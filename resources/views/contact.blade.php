                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="{{ __('messages.contactFormm') }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-2">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="name" name="subject" placeholder="{{ __('messages.contactFormة') }}" required>
                            </div>
                        </div>
