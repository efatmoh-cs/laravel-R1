  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>Aswan</p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>khdrft88@gmail.com</p>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>App Modile Developer/E.commerce APP with firebase</b></h5>
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Front End Developer / E.commerce page</b></h5>
      ...
      <div class="w3-container w3-card w3-white">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>College of staticts in Cario</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2013 - 2015</h6>
          <p>Master Degree</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>College of Energy in Aswan</b></h5>
